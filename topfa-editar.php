                        ...
                        <div class="box-content">
                            <div class="box-cadastro-site">
                                ...
                                <form name="formCadastro" id="form-cadastro" class="form-cadastro" action="" method="post" enctype="multipart/form-data" novalidate> 
                                    <input class="upload" id="uploadImage1" type="file" name="imagemCadastro" onchange="PreviewImage(1);" size="0" />
                                    <label class="inserir-foto"><i class="fa fa-photo"></i>Trocar Foto</label>
                                    <br style="clear:both"/>
                                    <img id="uploadPreview1" src="http://www.pida.com.br/midia/arquivo01Fans_top/paixaoinovamidiacombr.jpg" />
                                    <br style="clear:both"/>
                                    <input class="required" type="text" name="txtNome" placeholder="Nome do usuário" value="Everton Paixão" />
                                    <input class="email" type="text" disabled="disabled" name="txtEmail" placeholder="Email" value="paixao@inovamidia.com.br" />
                                    <input type="hidden" name="txt2Email" value="paixao@inovamidia.com.br" />
                                    <input class="" type="password" id="senha" name="txtSenha" value="" placeholder="Senha ( *deixe em branco caso não queira modificar )">
                                    <select class="required" id="ddlEstado" name="ddlEstado"></select>
                                    <select class="required" id="ddlCidade" name="ddlCidade"><option>Salvador</option></select>
                                    <input type="submit" value="EDITAR" name="btnEditarTFa">
                                </form>
                            </div>
                        </div>
                    </div>
